    ...
    <footer className="bg-black border-t border-purple-500/20">
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">LibationsPLUS</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/backoffice" className="text-gray-400 hover:text-yellow-400 transition-colors">Dashboard</Link></li>
        ...
        <div className="border-t border-purple-500/20 mt-8 pt-8 text-center">
          <p className="text-gray-400">© 2024 LibationsPLUS. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
