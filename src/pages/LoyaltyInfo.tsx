    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Get 1 point for every $1 spent</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-purple-400 rounded-full mt-2"></div>
                <div>
                  ...
                  <p className="text-gray-300">Extra points for visiting participating venues</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-purple-400 rounded-full mt-2"></div>
                <div>
                  ...
                  <p className="text-gray-300">Special treats on your special day</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Unlock better perks as you level up</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-yellow-400 rounded-full mt-2"></div>
                <div>
                  ...
                  <p className="text-gray-300">VIP access to member-only experiences</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                <div className="w-2 h-2 bg-yellow-400 rounded-full mt-2"></div>
                <div>
                  ...
                  <p className="text-gray-300">Earn points when friends join the program</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="bg-gray-900 border-gray-500/20">
              <CardHeader className="text-center">
